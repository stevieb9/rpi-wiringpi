...
separate C thread than your application.
...
up and leaving C<d4> through C<d7> as C<0>, the wiring must connect through 4
to 7. Look at LCD pin 4-7 as LCD pin 0-3 when in 4-bit mode.

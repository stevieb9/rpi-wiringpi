...
As your normal, every day user, install L<http://perlbrew.pl|perlbrew>, Then
install an instance of Perl, and switch to it:

    perlbrew install perl-5.24.0
    perlbrew switch perl-5.24.0

To use C<sudo> to install to and run scripts within the appropriate Perl
...
You should also change the user's profile to always use the proper perl.
Add the following to the very bottom of the user's C<~/.profile> file:

    PATH="/home/pi/perl5/perlbrew/perls/perl-5.24.0/bin:$PATH"

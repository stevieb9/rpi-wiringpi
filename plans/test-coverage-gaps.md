...
> **NEXT ACTION:** V10 — rpi-wiringpi core: device-factory validation dies (oled/lcd/expander/stepper_motor; servo/pwm non-root), Meta arg croaks, pin() collision + pin_to_gpio uninit croaks, smoke/isa for gps/hcsr04/hygrometer/spi/pin_map, meta_remove/unregister_object. (V8 is PAUSED until a DS3231 is online.)
> **LAST SESSION:** 2026-06-23 — V9 done: built wiringpi-api, fixed F5 (phys/wpi_to_gpio OOB guard), added `t/91-94` (spi_data, pin-map bounds, arg validation, bmp180 math; 28) + mirror `rpi-wiringpi/t/117-wiringpi_api_unit.t` (10); bumped to 3.1804 UNREL + reinstalled. Interrupt machinery split to V23. (V8 paused — DS3231 offline.)
> **ARCHIVE:** See test-coverage-gaps-archive.md for completed V1-V7, V9

...
> **NEXT ACTION:** V25 — Complete the wiringpi-version-single-source plan (BuildCheck in rpi-const, shim in all 20 dists, xt drift gate, docs; under its own plan file/rules) — re-verify vs the current tree first

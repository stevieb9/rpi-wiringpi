...
> **NEXT ACTION:** V17 — RPi::DHT11 noboard-mode coverage (RDE_NOBOARD_TEST=1; in ~/repos/rpi-dht11 + mirror) — re-verify vs the current tree first
...
> **ARCHIVE:** See test-platform-release-master-archive.md for completed V tasks (V1-V5, V7-V10, V12-V16, V33, V34)

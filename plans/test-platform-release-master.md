...
> **NEXT ACTION:** V23 — RPi::RTC::DS3231 depth (0-99 BCD round-trip + field maxes in t/532, temp decode incl. negative, HW-free setter validation croaks; in ~/repos/rpi-wiringpi + dist) — re-verify vs the current tree first
...
> **ARCHIVE:** See test-platform-release-master-archive.md for completed V tasks (V1-V5, V7-V10, V12-V22, V33, V34)

...
> **NEXT ACTION:** V24 — FAQ "RUNNING TESTS" prose audit (pin-doc pointer, breadboard link, t/420/421 board-2 gating, t/scripts disposition, regen docs; in ~/repos/rpi-wiringpi) — re-verify vs the current tree first
...
> **ARCHIVE:** See test-platform-release-master-archive.md for completed V tasks (V1-V5, V7-V10, V12-V23, V33, V34)

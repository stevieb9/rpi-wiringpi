...
> **NEXT ACTION:** V22 — WiringPi::API interrupt machinery HW-free (auto_dispatch_interrupts + background_interrupt + results channel via faked self-pipe; in ~/repos/wiringpi-api) — re-verify vs the current tree first
...
> **ARCHIVE:** See test-platform-release-master-archive.md for completed V tasks (V1-V5, V7-V10, V12-V21, V33, V34)

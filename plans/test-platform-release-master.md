...
> **NEXT ACTION:** V27 — t/425-servo.t calibration windows (USER powered rig; board-2): replace vacuous bounds with calibrated LEFT(60)/CENTRE(150)/RIGHT(255) + sweep windows in RPiTest.pm; same session live-proves t/400/t/405 model windows + poll conversions — this is a user-hardware session (with V35), must precede V28
>

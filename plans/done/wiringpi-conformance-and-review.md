...
> **CLOSED 2026-07-09 (master V1):** Both remaining tasks dispositioned — V24 overtaken by events (3.1802 shipped to CPAN 2026-06-12) and V47 carried forward to master V27 (test-platform-release-master.md). No open work remains in this plan. USER TODO (still valid): set `RPI_BOARD=1` on the rigs (`/etc/environment`); the old `PI_BOARD=1` is now inert.

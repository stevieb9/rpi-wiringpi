...
#   U1 MCP23017  I2C 0x20      t/330:32, t/450:24
...
#   M7 ULN2003 + 28BYJ-48      t/450:27-32 (driven via U1 Bank A)
...
NETS = [
 ...
 # analog loop-backs -- [T]
 ('DPOT_WIPER',[('U5','13'),('M1','A1')]),       # PW0 -> ADS#1 A1   t/345:23,54
 ...
 # expander internal loopback A4-7 <-> B4-7 -- [T] t/330:218-231
 ('EXP_LB4',[('U1','25'),('U1','5')]),
 ('EXP_LB5',[('U1','26'),('U1','6')]),
 ('EXP_LB6',[('U1','27'),('U1','7')]),
 ('EXP_LB7',[('U1','28'),('U1','8')]),

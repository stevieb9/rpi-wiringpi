...
per-board suites.
    ...
    400-pwm_hw_mods.t                            HW PWM sweep (read via ADC)          RPI_BOARD_2   RPI_SUDO, RPI_I2C
    405-pwm_i2c_adc.t                            PWM/I2C/ADC integration              RPI_BOARD_2   RPI_SUDO, RPI_ADC, RPI_I2C
    410-dac.t                                    MCP4922 DAC (read via MCP3008)       RPI_BOARD_2   RPI_MCP4922, RPI_MCP3008
    425-servo.t                                  Servo HW PWM (read via ADC)          RPI_BOARD_2   RPI_SUDO, RPI_SERVO, RPI_ADC, RPI_I2C
    435-shift_reg_adc.t                          74HC595 shift reg (read via ADC)     RPI_BOARD_2   RPI_MCP3008, RPI_SHIFTREG
    445-dpot.t                                   MCP4XXXX digital pot (read via ADC)  RPI_BOARD_2   RPI_DIGIPOT, RPI_ADC
